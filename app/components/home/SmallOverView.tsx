        ...
        <div className="bg-white py-14 px-4">
            <div className="space-y-8 w-full max-w-6xl mx-auto">
                <div className="text-center space-y-2">
                    <h3 className="text-4xl font-medium text-center text-gray-800 ">Architectural agency</h3>
                    <p className="text-base text-zinc-700 max-w-3xl mx-auto">
                ...
                <div className="md:hidden flex flex-col gap-6">
                    ...
                    <div className="bg-[#F2F2F2] p-8 rounded-3xl text-gray-600 space-y-3">
